// ======================================================================
// UEXTFirmware.v generated from TopDesign.cysch
// 04/03/2020 at 23:48
...
module BLE_v3_63_0 (
	...
	cy_clock_v1_0
		#(.id("9f7d0c26-dae2-4080-b3f1-971693a1605f/5ae6fa4d-f41a-4a35-8821-7ce70389cb0c"),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("8122bd66-07d4-4037-a1a0-2c152b6baa65"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("1b678c9c-1923-4f42-b733-41b447a24559"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
