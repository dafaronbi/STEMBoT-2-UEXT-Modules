    ...
    /* UEXT service */
    {
        0x0010u, /* Handle of the UEXT service */ 
        {
            ...
            /* UEXT READ characteristic */
            {
                ...
                {
                    0x0013u, /* Handle of the READ DATA FROM STEMBoT descriptor */ 
                }, 
            },

            /* UEXT WRITE characteristic */
            {
                0x0015u, /* Handle of the UEXT WRITE characteristic */ 
                
                /* Array of Descriptors handles */
                {
                    0x0016u, /* Handle of the WRITE DATA TO STEMBoT descriptor */ 
                }, 
            },
        }, 
    },
