...
#define CYBLE_UEXT_UEXT_READ_READ_DATA_FROM_STEMBOT_DESC_INDEX   (0x00u) /* Index of READ DATA FROM STEMBoT descriptor */
#define CYBLE_UEXT_UEXT_WRITE_CHAR_INDEX   (0x01u) /* Index of UEXT WRITE characteristic */
#define CYBLE_UEXT_UEXT_WRITE_WRITE_DATA_TO_STEMBOT_DESC_INDEX   (0x00u) /* Index of WRITE DATA TO STEMBoT descriptor */
...
#define CYBLE_UEXT_UEXT_READ_READ_DATA_FROM_STEMBOT_DESC_HANDLE   (0x0013u) /* Handle of READ DATA FROM STEMBoT descriptor */
#define CYBLE_UEXT_UEXT_WRITE_DECL_HANDLE   (0x0014u) /* Handle of UEXT WRITE characteristic declaration */
#define CYBLE_UEXT_UEXT_WRITE_CHAR_HANDLE   (0x0015u) /* Handle of UEXT WRITE characteristic */
#define CYBLE_UEXT_UEXT_WRITE_WRITE_DATA_TO_STEMBOT_DESC_HANDLE   (0x0016u) /* Handle of WRITE DATA TO STEMBoT descriptor */
